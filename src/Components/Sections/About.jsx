  ...
  return (
    <div className="flex flex-col md:flex-row h-full">
      ...
      <div className="group border hidden md:block">
        <div className="absolute h-[40vh] bottom-[1.95%] rounded-lg left-6 w-[20vw] bg-gray-800 opacity-50 z-10 transition transform scale-95 ease-in-out duration-500 group-hover:scale-75"></div>
        <div className="absolute h-[40vh] bottom-[1.95%] left-6 w-[20vw] bg-transparent z-10 transition transform scale-95 ease-in-out duration-500  group-hover:scale-100">
          <img src="/user1.png" alt="" className="w-full h-full" />
        </div>
      </div>
